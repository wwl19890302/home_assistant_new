...
static int8_t ICACHE_FLASH_ATTR gizDataPoint2Event(gizwitsIssued_t *issuedData, eventInfo_t *info, dataPoint_t *dataPoints)
{
    ...
    if(0x01 == issuedData->attrFlags.flaglight1)
    {
        info->event[info->num] = EVENT_light1;
        info->num++;
        dataPoints->valuelight1 = gizStandardDecompressionValue(light1_BYTEOFFSET,light1_BITOFFSET,light1_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight2)
    {
        info->event[info->num] = EVENT_light2;
        info->num++;
        dataPoints->valuelight2 = gizStandardDecompressionValue(light2_BYTEOFFSET,light2_BITOFFSET,light2_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight3)
    {
        info->event[info->num] = EVENT_light3;
        info->num++;
        dataPoints->valuelight3 = gizStandardDecompressionValue(light3_BYTEOFFSET,light3_BITOFFSET,light3_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight4)
    {
        info->event[info->num] = EVENT_light4;
        info->num++;
        dataPoints->valuelight4 = gizStandardDecompressionValue(light4_BYTEOFFSET,light4_BITOFFSET,light4_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight5)
    {
        info->event[info->num] = EVENT_light5;
        info->num++;
        dataPoints->valuelight5 = gizStandardDecompressionValue(light5_BYTEOFFSET,light5_BITOFFSET,light5_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight6)
    {
        info->event[info->num] = EVENT_light6;
        info->num++;
        dataPoints->valuelight6 = gizStandardDecompressionValue(light6_BYTEOFFSET,light6_BITOFFSET,light6_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight7)
    {
        info->event[info->num] = EVENT_light7;
        info->num++;
        dataPoints->valuelight7 = gizStandardDecompressionValue(light7_BYTEOFFSET,light7_BITOFFSET,light7_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight8)
    {
        info->event[info->num] = EVENT_light8;
        info->num++;
        dataPoints->valuelight8 = gizStandardDecompressionValue(light8_BYTEOFFSET,light8_BITOFFSET,light8_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flaglight9)
    {
        info->event[info->num] = EVENT_light9;
        info->num++;
        dataPoints->valuelight9 = gizStandardDecompressionValue(light9_BYTEOFFSET,light9_BITOFFSET,light9_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagwater_heater)
    {
        info->event[info->num] = EVENT_water_heater;
        info->num++;
        dataPoints->valuewater_heater = gizStandardDecompressionValue(water_heater_BYTEOFFSET,water_heater_BITOFFSET,water_heater_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagTV)
    {
        info->event[info->num] = EVENT_TV;
        info->num++;
        dataPoints->valueTV = gizStandardDecompressionValue(TV_BYTEOFFSET,TV_BITOFFSET,TV_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
    ...
    if(0x01 == issuedData->attrFlags.flagair_condition_onoff)
    {
        info->event[info->num] = EVENT_air_condition_onoff;
        info->num++;
        dataPoints->valueair_condition_onoff = gizStandardDecompressionValue(air_condition_onoff_BYTEOFFSET,air_condition_onoff_BITOFFSET,air_condition_onoff_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagmusic_onoff)
    {
        info->event[info->num] = EVENT_music_onoff;
        info->num++;
        dataPoints->valuemusic_onoff = gizStandardDecompressionValue(music_onoff_BYTEOFFSET,music_onoff_BITOFFSET,music_onoff_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagmusic_prevnext)
    {
        info->event[info->num] = EVENT_music_prevnext;
        info->num++;
        dataPoints->valuemusic_prevnext = gizStandardDecompressionValue(music_prevnext_BYTEOFFSET,music_prevnext_BITOFFSET,music_prevnext_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagmusic_voice_updown)
    {
        info->event[info->num] = EVENT_music_voice_updown;
        info->num++;
        dataPoints->valuemusic_voice_updown = gizStandardDecompressionValue(music_voice_updown_BYTEOFFSET,music_voice_updown_BITOFFSET,music_voice_updown_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagswitch1_onoff)
    {
        info->event[info->num] = EVENT_switch1_onoff;
        info->num++;
        dataPoints->valueswitch1_onoff = gizStandardDecompressionValue(switch1_onoff_BYTEOFFSET,switch1_onoff_BITOFFSET,switch1_onoff_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagswitch2_onoff)
    {
        info->event[info->num] = EVENT_switch2_onoff;
        info->num++;
        dataPoints->valueswitch2_onoff = gizStandardDecompressionValue(switch2_onoff_BYTEOFFSET,switch2_onoff_BITOFFSET,switch2_onoff_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagswitch3_onoff)
    {
        info->event[info->num] = EVENT_switch3_onoff;
        info->num++;
        dataPoints->valueswitch3_onoff = gizStandardDecompressionValue(switch3_onoff_BYTEOFFSET,switch3_onoff_BITOFFSET,switch3_onoff_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
    if(0x01 == issuedData->attrFlags.flagair_condition_mode)
    {
        info->event[info->num] = EVENT_air_condition_mode;
        info->num++;
        dataPoints->valueair_condition_mode = gizStandardDecompressionValue(air_condition_mode_BYTEOFFSET,air_condition_mode_BITOFFSET,air_condition_mode_LEN,(uint8_t *)&issuedData->attrVals.wBitBuf,sizeof(issuedData->attrVals.wBitBuf));
    }
        
        
    if(0x01 == issuedData->attrFlags.flagair_condition_temperature)
    {
        info->event[info->num] = EVENT_air_condition_temperature;
        info->num++;
        dataPoints->valueair_condition_temperature = gizX2Y(air_condition_temperature_RATIO,  air_condition_temperature_ADDITION, issuedData->attrVals.valueair_condition_temperature); 
    }
...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valuelight1 != cur->valuelight1)
    {
        GIZWITS_LOG("valuelight1 Changed\n");
        ret = 1;
    }
    if(last->valuelight2 != cur->valuelight2)
    {
        GIZWITS_LOG("valuelight2 Changed\n");
        ret = 1;
    }
    if(last->valuelight3 != cur->valuelight3)
    {
        GIZWITS_LOG("valuelight3 Changed\n");
        ret = 1;
    }
    if(last->valuelight4 != cur->valuelight4)
    {
        GIZWITS_LOG("valuelight4 Changed\n");
        ret = 1;
    }
    if(last->valuelight5 != cur->valuelight5)
    {
        GIZWITS_LOG("valuelight5 Changed\n");
        ret = 1;
    }
    if(last->valuelight6 != cur->valuelight6)
    {
        GIZWITS_LOG("valuelight6 Changed\n");
        ret = 1;
    }
    if(last->valuelight7 != cur->valuelight7)
    {
        GIZWITS_LOG("valuelight7 Changed\n");
        ret = 1;
    }
    if(last->valuelight8 != cur->valuelight8)
    {
        GIZWITS_LOG("valuelight8 Changed\n");
        ret = 1;
    }
    if(last->valuelight9 != cur->valuelight9)
    {
        GIZWITS_LOG("valuelight9 Changed\n");
        ret = 1;
    }
    if(last->valuewater_heater != cur->valuewater_heater)
    {
        GIZWITS_LOG("valuewater_heater Changed\n");
        ret = 1;
    }
    if(last->valueTV != cur->valueTV)
    {
        GIZWITS_LOG("valueTV Changed\n");
        ret = 1;
    }
    ...
    if(last->valueair_condition_onoff != cur->valueair_condition_onoff)
    {
        GIZWITS_LOG("valueair_condition_onoff Changed\n");
        ret = 1;
    }
    if(last->valuemusic_onoff != cur->valuemusic_onoff)
    {
        GIZWITS_LOG("valuemusic_onoff Changed\n");
        ret = 1;
    }
    if(last->valuemusic_prevnext != cur->valuemusic_prevnext)
    {
        GIZWITS_LOG("valuemusic_prevnext Changed\n");
        ret = 1;
    }
    if(last->valuemusic_voice_updown != cur->valuemusic_voice_updown)
    {
        GIZWITS_LOG("valuemusic_voice_updown Changed\n");
        ret = 1;
    }
    if(last->valueswitch1_onoff != cur->valueswitch1_onoff)
    {
        GIZWITS_LOG("valueswitch1_onoff Changed\n");
        ret = 1;
    }
    if(last->valueswitch2_onoff != cur->valueswitch2_onoff)
    {
        GIZWITS_LOG("valueswitch2_onoff Changed\n");
        ret = 1;
    }
    if(last->valueswitch3_onoff != cur->valueswitch3_onoff)
    {
        GIZWITS_LOG("valueswitch3_onoff Changed\n");
        ret = 1;
    }
    if(last->valueair_condition_mode != cur->valueair_condition_mode)
    {
        GIZWITS_LOG("valueair_condition_mode Changed\n");
        ret = 1;
    }
    if(last->valueair_condition_temperature != cur->valueair_condition_temperature)
    {
        GIZWITS_LOG("valueair_condition_temperature Changed\n");
        ret = 1;
    }
    if(last->valuedoor_onoff != cur->valuedoor_onoff)
    {
        GIZWITS_LOG("valuedoor_onoff Changed\n");
        ret = 1;
    }
    if(last->valuewindow1_onoff != cur->valuewindow1_onoff)
    {
        GIZWITS_LOG("valuewindow1_onoff Changed\n");
        ret = 1;
    }
    if(last->valuewindow2_onoff != cur->valuewindow2_onoff)
    {
        GIZWITS_LOG("valuewindow2_onoff Changed\n");
        ret = 1;
    }
    if(last->valuewindow3_onoff != cur->valuewindow3_onoff)
    {
        GIZWITS_LOG("valuewindow3_onoff Changed\n");
        ret = 1;
    }
    if(last->valuewindow4_onoff != cur->valuewindow4_onoff)
    {
        GIZWITS_LOG("valuewindow4_onoff Changed\n");
        ret = 1;
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    gizStandardCompressValue(light1_BYTEOFFSET,light1_BITOFFSET,light1_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight1);
    gizStandardCompressValue(light2_BYTEOFFSET,light2_BITOFFSET,light2_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight2);
    gizStandardCompressValue(light3_BYTEOFFSET,light3_BITOFFSET,light3_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight3);
    gizStandardCompressValue(light4_BYTEOFFSET,light4_BITOFFSET,light4_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight4);
    gizStandardCompressValue(light5_BYTEOFFSET,light5_BITOFFSET,light5_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight5);
    gizStandardCompressValue(light6_BYTEOFFSET,light6_BITOFFSET,light6_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight6);
    gizStandardCompressValue(light7_BYTEOFFSET,light7_BITOFFSET,light7_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight7);
    gizStandardCompressValue(light8_BYTEOFFSET,light8_BITOFFSET,light8_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight8);
    gizStandardCompressValue(light9_BYTEOFFSET,light9_BITOFFSET,light9_LEN,(uint8_t *)devStatusPtr,dataPoints->valuelight9);
    gizStandardCompressValue(water_heater_BYTEOFFSET,water_heater_BITOFFSET,water_heater_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewater_heater);
    gizStandardCompressValue(TV_BYTEOFFSET,TV_BITOFFSET,TV_LEN,(uint8_t *)devStatusPtr,dataPoints->valueTV);
    gizStandardCompressValue(curtain_BYTEOFFSET,curtain_BITOFFSET,curtain_LEN,(uint8_t *)devStatusPtr,dataPoints->valuecurtain);
    gizStandardCompressValue(air_condition_onoff_BYTEOFFSET,air_condition_onoff_BITOFFSET,air_condition_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valueair_condition_onoff);
    gizStandardCompressValue(music_onoff_BYTEOFFSET,music_onoff_BITOFFSET,music_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuemusic_onoff);
    gizStandardCompressValue(music_prevnext_BYTEOFFSET,music_prevnext_BITOFFSET,music_prevnext_LEN,(uint8_t *)devStatusPtr,dataPoints->valuemusic_prevnext);
    gizStandardCompressValue(music_voice_updown_BYTEOFFSET,music_voice_updown_BITOFFSET,music_voice_updown_LEN,(uint8_t *)devStatusPtr,dataPoints->valuemusic_voice_updown);
    gizStandardCompressValue(switch1_onoff_BYTEOFFSET,switch1_onoff_BITOFFSET,switch1_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valueswitch1_onoff);
    gizStandardCompressValue(switch2_onoff_BYTEOFFSET,switch2_onoff_BITOFFSET,switch2_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valueswitch2_onoff);
    gizStandardCompressValue(switch3_onoff_BYTEOFFSET,switch3_onoff_BITOFFSET,switch3_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valueswitch3_onoff);
    if(dataPoints->valueair_condition_mode >= air_condition_mode_VALUE_MAX)
    {
        GIZWITS_LOG("[ERROR] valueair_condition_mode Error , Illegal Overstep\n");
        return -1;
    }
    else
    {
        gizStandardCompressValue(air_condition_mode_BYTEOFFSET,air_condition_mode_BITOFFSET,air_condition_mode_LEN,(uint8_t *)devStatusPtr,dataPoints->valueair_condition_mode);  
    }
    gizStandardCompressValue(door_onoff_BYTEOFFSET,door_onoff_BITOFFSET,door_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuedoor_onoff);
    gizStandardCompressValue(window1_onoff_BYTEOFFSET,window1_onoff_BITOFFSET,window1_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewindow1_onoff);
    gizStandardCompressValue(window2_onoff_BYTEOFFSET,window2_onoff_BITOFFSET,window2_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewindow2_onoff);
    gizStandardCompressValue(window3_onoff_BYTEOFFSET,window3_onoff_BITOFFSET,window3_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewindow3_onoff);
    gizStandardCompressValue(window4_onoff_BYTEOFFSET,window4_onoff_BITOFFSET,window4_onoff_LEN,(uint8_t *)devStatusPtr,dataPoints->valuewindow4_onoff);
    ...
    devStatusPtr->valueair_condition_temperature = gizY2X(air_condition_temperature_RATIO,  air_condition_temperature_ADDITION, dataPoints->valueair_condition_temperature); 
