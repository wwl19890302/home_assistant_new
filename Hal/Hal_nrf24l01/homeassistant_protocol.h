...
#ifndef _HOMEASSISTANT_PROTOCOL_H
#define _HOMEASSISTANT_PROTOCOL_H
...
* @{
*/
#define PRODUCT_KEY "62ba28e1c3804a9cbb9b39a379771b58"
/**@} */
/**@name Product Secret
* @{
*/
#define PRODUCT_SECRET "392cb295e0724c119e4f3f6032d2aa13"
...
* @{
*/
#define light1_BYTEOFFSET                    0
#define light1_BITOFFSET                     0
#define light1_LEN                           1
#define light2_BYTEOFFSET                    0
#define light2_BITOFFSET                     1
#define light2_LEN                           1
#define light3_BYTEOFFSET                    0
#define light3_BITOFFSET                     2
#define light3_LEN                           1
#define light4_BYTEOFFSET                    0
#define light4_BITOFFSET                     3
#define light4_LEN                           1
#define light5_BYTEOFFSET                    0
#define light5_BITOFFSET                     4
#define light5_LEN                           1
#define light6_BYTEOFFSET                    0
#define light6_BITOFFSET                     5
#define light6_LEN                           1
#define light7_BYTEOFFSET                    0
#define light7_BITOFFSET                     6
#define light7_LEN                           1
#define light8_BYTEOFFSET                    0
#define light8_BITOFFSET                     7
#define light8_LEN                           1
#define light9_BYTEOFFSET                    1
#define light9_BITOFFSET                     8
#define light9_LEN                           1
#define water_heater_BYTEOFFSET                    1
#define water_heater_BITOFFSET                     9
#define water_heater_LEN                           1
#define TV_BYTEOFFSET                    1
#define TV_BITOFFSET                     10
#define TV_LEN                           1
#define curtain_BYTEOFFSET                    1
#define curtain_BITOFFSET                     11
#define curtain_LEN                           1
#define air_condition_onoff_BYTEOFFSET                    1
#define air_condition_onoff_BITOFFSET                     12
#define air_condition_onoff_LEN                           1
#define music_onoff_BYTEOFFSET                    1
#define music_onoff_BITOFFSET                     13
#define music_onoff_LEN                           1
#define music_prevnext_BYTEOFFSET                    1
#define music_prevnext_BITOFFSET                     14
#define music_prevnext_LEN                           1
#define music_voice_updown_BYTEOFFSET                    1
#define music_voice_updown_BITOFFSET                     15
#define music_voice_updown_LEN                           1
#define switch1_onoff_BYTEOFFSET                    2
#define switch1_onoff_BITOFFSET                     16
#define switch1_onoff_LEN                           1
#define switch2_onoff_BYTEOFFSET                    2
#define switch2_onoff_BITOFFSET                     17
#define switch2_onoff_LEN                           1
#define switch3_onoff_BYTEOFFSET                    2
#define switch3_onoff_BITOFFSET                     18
#define switch3_onoff_LEN                           1
#define air_condition_mode_BYTEOFFSET                    2
#define air_condition_mode_BITOFFSET                     19
#define air_condition_mode_LEN                           1
#define door_onoff_BYTEOFFSET                    4
#define door_onoff_BITOFFSET                     0
#define door_onoff_LEN                           1
#define window1_onoff_BYTEOFFSET                    4
#define window1_onoff_BITOFFSET                     1
#define window1_onoff_LEN                           1
#define window2_onoff_BYTEOFFSET                    4
#define window2_onoff_BITOFFSET                     2
#define window2_onoff_LEN                           1
#define window3_onoff_BYTEOFFSET                    4
#define window3_onoff_BITOFFSET                     3
#define window3_onoff_LEN                           1
#define window4_onoff_BYTEOFFSET                    4
#define window4_onoff_BITOFFSET                     4
#define window4_onoff_LEN                           1

#define air_condition_temperature_RATIO                         1
#define air_condition_temperature_ADDITION                      16
#define air_condition_temperature_MIN                           0
#define air_condition_temperature_MAX                           14
/**@} */

/** Writable data points Boolean and enumerated variables occupy byte size */
#define COUNT_W_BIT 3
...
typedef enum
{
    air_condition_mode_VALUE0 = 0,//制热
    air_condition_mode_VALUE1 = 1,//制冷
    air_condition_mode_VALUE_MAX,
} air_condition_mode_ENUM_T;
...
typedef enum
{
  ...
  EVENT_TV,
  EVENT_curtain,
  EVENT_air_condition_onoff,
  EVENT_music_onoff,
  EVENT_music_prevnext,
  EVENT_music_voice_updown,
  EVENT_switch1_onoff,
  EVENT_switch2_onoff,
  EVENT_switch3_onoff,
  EVENT_air_condition_mode,
  EVENT_air_condition_temperature,
...
typedef struct {
  ...
  bool valuelight8;
  bool valuelight9;
  bool valuewater_heater;
  bool valueTV;
  bool valuecurtain;
  bool valueair_condition_onoff;
  bool valuemusic_onoff;
  bool valuemusic_prevnext;
  bool valuemusic_voice_updown;
  bool valueswitch1_onoff;
  bool valueswitch2_onoff;
  bool valueswitch3_onoff;
  uint32_t valueair_condition_mode;
  uint32_t valueair_condition_temperature;
  bool valuedoor_onoff;
  bool valuewindow1_onoff;
  bool valuewindow2_onoff;
  bool valuewindow3_onoff;
  bool valuewindow4_onoff;
} dataPoint_t;


/** Corresponding to the protocol "4.10 WiFi module control device" in the flag " attr_flags" */
typedef struct {
  uint8_t flaglight1:1;
  uint8_t flaglight2:1;
  uint8_t flaglight3:1;
  uint8_t flaglight4:1;
  uint8_t flaglight5:1;
  uint8_t flaglight6:1;
  uint8_t flaglight7:1;
  uint8_t flaglight8:1;
  uint8_t flaglight9:1;
  uint8_t flagwater_heater:1;
  uint8_t flagTV:1;
  uint8_t flagcurtain:1;
  uint8_t flagair_condition_onoff:1;
  uint8_t flagmusic_onoff:1;
  uint8_t flagmusic_prevnext:1;
  uint8_t flagmusic_voice_updown:1;
  uint8_t flagswitch1_onoff:1;
  uint8_t flagswitch2_onoff:1;
  uint8_t flagswitch3_onoff:1;
  uint8_t flagair_condition_mode:1;
  uint8_t flagair_condition_temperature:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueair_condition_temperature;
} attrVals_t;
